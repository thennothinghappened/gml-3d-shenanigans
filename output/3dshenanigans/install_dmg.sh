...
YYInstallDir=/Users/orca/gamemakerstudio2/GM_MAC/3dshenanigans
YYDMGName=Mac-YoYoRunner-Release.dmg
YYDmgMD5=f26288ccfde8d41f5401b54c099b2d7d 
YYAppStore=0

if [ ! -d "$YYInstallDir" ]; then
	mkdir -p "$YYInstallDir"
fi
